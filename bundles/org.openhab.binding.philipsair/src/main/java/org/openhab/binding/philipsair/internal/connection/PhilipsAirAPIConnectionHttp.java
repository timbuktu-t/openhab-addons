...
@NonNullByDefault
public class PhilipsAirAPIConnectionHttp implements PhilipsAirAPIConnection {
    private final Logger logger = LoggerFactory.getLogger(PhilipsAirAPIConnectionHttp.class);
    ...
    public PhilipsAirAPIConnectionHttp(PhilipsAirConfiguration config, HttpClient httpClient) {
